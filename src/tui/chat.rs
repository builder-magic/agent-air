...
use super::themes::theme as app_theme;
use super::markdown::{render_markdown_with_prefix, wrap_with_prefix};
...
impl ChatView {
    ...
    pub fn render(&mut self, frame: &mut Frame, area: Rect, pending_status: Option<&str>) {
