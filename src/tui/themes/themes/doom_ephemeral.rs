...
const BG: Color = Color::Rgb(0x32, 0x3f, 0x4e);
const BG_ALT: Color = Color::Rgb(0x28, 0x32, 0x3e);
const FG: Color = Color::Rgb(0xf8, 0xf8, 0xf2);
const FG_ALT: Color = Color::Rgb(0xfd, 0xfd, 0xfd);
const BASE4: Color = Color::Rgb(0x88, 0x97, 0xf4);
const RED: Color = Color::Rgb(0xf4, 0x8f, 0xb1);
const ORANGE: Color = Color::Rgb(0xf2, 0xa2, 0x72);
const YELLOW: Color = Color::Rgb(0xf1, 0xfa, 0x8c);
const GREEN: Color = Color::Rgb(0x53, 0xe2, 0xae);
const CYAN: Color = Color::Rgb(0x79, 0xe6, 0xf3);
const BLUE: Color = Color::Rgb(0x92, 0xb6, 0xf4);
const MAGENTA: Color = Color::Rgb(0xBD, 0x99, 0xFF);
const VIOLET: Color = Color::Rgb(0x88, 0x97, 0xf4);
