...
const BG_ALT: Color = Color::Rgb(0x1E, 0x20, 0x29);
const FG: Color = Color::Rgb(0xf8, 0xf8, 0xf2);
const FG_ALT: Color = Color::Rgb(0x62, 0x72, 0xa4);
const BASE4: Color = Color::Rgb(0x56, 0x57, 0x61);
...
const BLUE: Color = Color::Rgb(0x61, 0xbf, 0xff);
