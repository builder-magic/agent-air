...
const BG_ALT: Color = Color::Rgb(0xf2, 0xf2, 0xf2);
const FG: Color = Color::Rgb(0x4d, 0x4d, 0x4c);
const FG_ALT: Color = Color::Rgb(0xa3, 0xa1, 0xa1);
const BASE4: Color = Color::Rgb(0xc0, 0xbf, 0xbf);
const RED: Color = Color::Rgb(0xc8, 0x28, 0x29);
const ORANGE: Color = Color::Rgb(0xf5, 0x87, 0x1f);
const YELLOW: Color = Color::Rgb(0xea, 0xb7, 0x00);
const GREEN: Color = Color::Rgb(0x71, 0x8c, 0x00);
const CYAN: Color = Color::Rgb(0x3e, 0x99, 0x9f);
const BLUE: Color = Color::Rgb(0x42, 0x71, 0xae);
const MAGENTA: Color = Color::Rgb(0xc6, 0x78, 0xdd);
const VIOLET: Color = Color::Rgb(0x89, 0x59, 0xa8);
