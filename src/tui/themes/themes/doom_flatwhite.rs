...
const BG: Color = Color::Rgb(0xF7, 0xF3, 0xEE);
const BG_ALT: Color = Color::Rgb(0xE8, 0xE4, 0xDF);
const FG: Color = Color::Rgb(0x60, 0x5A, 0x52);
const FG_ALT: Color = Color::Rgb(0x93, 0x8D, 0x86);
const BASE4: Color = Color::Rgb(0xB9, 0xB3, 0xAB);
const RED: Color = Color::Rgb(0xD0, 0x2B, 0x61);
const ORANGE: Color = Color::Rgb(0xDB, 0x78, 0x4D);
const YELLOW: Color = Color::Rgb(0xB6, 0x8D, 0x4C);
const GREEN: Color = Color::Rgb(0x48, 0x9E, 0x63);
const CYAN: Color = Color::Rgb(0x2A, 0x95, 0x99);
const BLUE: Color = Color::Rgb(0x3B, 0x6E, 0xA8);
const MAGENTA: Color = Color::Rgb(0xA6, 0x58, 0xA6);
const VIOLET: Color = Color::Rgb(0x7A, 0x3E, 0x9D);
