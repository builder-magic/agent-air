...
const BG: Color = Color::Rgb(0x2a, 0x29, 0x26);
const BG_ALT: Color = Color::Rgb(0x24, 0x23, 0x21);
const FG: Color = Color::Rgb(0xe6, 0xd6, 0xac);
const FG_ALT: Color = Color::Rgb(0x87, 0x87, 0x87);
const BASE4: Color = Color::Rgb(0x5c, 0x5c, 0x5c);
const RED: Color = Color::Rgb(0xe6, 0x8a, 0x83);
const ORANGE: Color = Color::Rgb(0xe3, 0x97, 0x72);
const YELLOW: Color = Color::Rgb(0xd9, 0xbb, 0x80);
const GREEN: Color = Color::Rgb(0x87, 0xc0, 0x95);
const CYAN: Color = Color::Rgb(0x83, 0xb0, 0x9a);
const BLUE: Color = Color::Rgb(0x89, 0xbe, 0xba);
const MAGENTA: Color = Color::Rgb(0xd3, 0xa0, 0xbc);
const VIOLET: Color = Color::Rgb(0xb0, 0xa0, 0xc0);
