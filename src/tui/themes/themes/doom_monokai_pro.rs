...
// Color palette
const BG: Color = Color::Rgb(0x2D, 0x2A, 0x2E);
const BG_ALT: Color = Color::Rgb(0x22, 0x1F, 0x22);
const FG: Color = Color::Rgb(0xFC, 0xFC, 0xFA);
const FG_ALT: Color = Color::Rgb(0x93, 0x92, 0x93);
const BASE4: Color = Color::Rgb(0x38, 0x35, 0x39);
const RED: Color = Color::Rgb(0xCC, 0x66, 0x66);
const ORANGE: Color = Color::Rgb(0xFC, 0x98, 0x67);
const YELLOW: Color = Color::Rgb(0xFF, 0xD8, 0x66);
const GREEN: Color = Color::Rgb(0xA9, 0xDC, 0x76);
const CYAN: Color = Color::Rgb(0x78, 0xDC, 0xE8);
const BLUE: Color = Color::Rgb(0x78, 0xDC, 0xE8);
const MAGENTA: Color = Color::Rgb(0xFF, 0x61, 0x88);
const VIOLET: Color = Color::Rgb(0xAB, 0x9D, 0xF2);
