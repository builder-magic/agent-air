...
const BG_ALT: Color = Color::Rgb(0x14, 0x14, 0x14);
const FG: Color = Color::Rgb(0xBA, 0xBB, 0xF1);
const FG_ALT: Color = Color::Rgb(0x53, 0x57, 0x63);
const BASE4: Color = Color::Rgb(0x53, 0x57, 0x63);
const RED: Color = Color::Rgb(0xFF, 0x63, 0x77);
const ORANGE: Color = Color::Rgb(0xE9, 0xC0, 0x62);
const YELLOW: Color = Color::Rgb(0xEC, 0xBE, 0x7B);
const GREEN: Color = Color::Rgb(0xA6, 0xE2, 0x2E);
