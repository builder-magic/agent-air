...
const BG: Color = Color::Rgb(0x17, 0x20, 0x30);
const BG_ALT: Color = Color::Rgb(0x10, 0x18, 0x28);
const FG: Color = Color::Rgb(0xFA, 0xFF, 0xF6);
const FG_ALT: Color = Color::Rgb(0xA7, 0xAC, 0xB9);
const BASE4: Color = Color::Rgb(0x5D, 0x80, 0xAE);
const RED: Color = Color::Rgb(0xc6, 0x79, 0x7e);
const ORANGE: Color = Color::Rgb(0xea, 0xbe, 0x9a);
const YELLOW: Color = Color::Rgb(0xF7, 0xE3, 0xAF);
const GREEN: Color = Color::Rgb(0xA3, 0xB0, 0x9A);
const CYAN: Color = Color::Rgb(0x88, 0xC0, 0xD0);
const BLUE: Color = Color::Rgb(0x6e, 0x94, 0xb9);
const MAGENTA: Color = Color::Rgb(0xb1, 0x8b, 0xb1);
const VIOLET: Color = Color::Rgb(0x5D, 0x80, 0xAE);
