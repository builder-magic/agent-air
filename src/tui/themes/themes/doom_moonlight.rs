...
const BG: Color = Color::Rgb(0x21, 0x23, 0x37);
const BG_ALT: Color = Color::Rgb(0x19, 0x1a, 0x2a);
const FG: Color = Color::Rgb(0xc8, 0xd3, 0xf5);
const FG_ALT: Color = Color::Rgb(0xb4, 0xc2, 0xf0);
const BASE4: Color = Color::Rgb(0x44, 0x48, 0x68);
const RED: Color = Color::Rgb(0xff, 0x75, 0x7f);
const ORANGE: Color = Color::Rgb(0xff, 0x99, 0x5e);
const YELLOW: Color = Color::Rgb(0xff, 0xc7, 0x77);
const GREEN: Color = Color::Rgb(0xc3, 0xe8, 0x8d);
const CYAN: Color = Color::Rgb(0xb4, 0xf9, 0xf8);
const BLUE: Color = Color::Rgb(0x82, 0xaa, 0xff);
const MAGENTA: Color = Color::Rgb(0xc0, 0x99, 0xff);
const VIOLET: Color = Color::Rgb(0xf9, 0x89, 0xd3);
