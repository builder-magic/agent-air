...
const BG: Color = Color::Rgb(0x0C, 0x0A, 0x20);
const BG_ALT: Color = Color::Rgb(0x18, 0x16, 0x38);
const FG: Color = Color::Rgb(0xF0, 0xF0, 0xF0);
const FG_ALT: Color = Color::Rgb(0x55, 0x53, 0x88);
const BASE4: Color = Color::Rgb(0x4A, 0x46, 0x8A);
const RED: Color = Color::Rgb(0xE9, 0x3C, 0x58);
const ORANGE: Color = Color::Rgb(0xFF, 0x8F, 0x00);
const YELLOW: Color = Color::Rgb(0xF2, 0xCE, 0x00);
const GREEN: Color = Color::Rgb(0x0E, 0xE9, 0xB5);
const CYAN: Color = Color::Rgb(0x66, 0xFF, 0xF3);
const BLUE: Color = Color::Rgb(0x51, 0xAF, 0xEF);
const MAGENTA: Color = Color::Rgb(0xEA, 0x51, 0xB2);
const VIOLET: Color = Color::Rgb(0xB1, 0x6B, 0xFF);
