...
const BG: Color = Color::Rgb(0x24, 0x27, 0x30);
const BG_ALT: Color = Color::Rgb(0x2a, 0x2e, 0x38);
const FG: Color = Color::Rgb(0xbb, 0xc2, 0xcf);
const FG_ALT: Color = Color::Rgb(0x5D, 0x65, 0x6B);
const BASE4: Color = Color::Rgb(0x5D, 0x65, 0x6B);
const RED: Color = Color::Rgb(0xff, 0x66, 0x5c);
const ORANGE: Color = Color::Rgb(0xe6, 0x90, 0x55);
const YELLOW: Color = Color::Rgb(0xFC, 0xCE, 0x7B);
const GREEN: Color = Color::Rgb(0x7b, 0xc2, 0x75);
const CYAN: Color = Color::Rgb(0x5c, 0xEf, 0xFF);
const BLUE: Color = Color::Rgb(0x51, 0xaf, 0xef);
const MAGENTA: Color = Color::Rgb(0xC5, 0x7B, 0xDB);
const VIOLET: Color = Color::Rgb(0xa9, 0x91, 0xf1);
