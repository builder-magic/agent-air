...
const BG: Color = Color::Rgb(0x28, 0x2b, 0x33);
const BG_ALT: Color = Color::Rgb(0x1f, 0x20, 0x24);
const FG: Color = Color::Rgb(0xc6, 0xc6, 0xc6);
const FG_ALT: Color = Color::Rgb(0xc9, 0xd9, 0xff);
const BASE4: Color = Color::Rgb(0x72, 0x89, 0xbc);
const RED: Color = Color::Rgb(0xe1, 0xc1, 0xee);
const ORANGE: Color = Color::Rgb(0xa6, 0xc1, 0xe0);
const YELLOW: Color = Color::Rgb(0xcf, 0xcf, 0x9c);
const GREEN: Color = Color::Rgb(0x5b, 0x94, 0xab);
const CYAN: Color = Color::Rgb(0x72, 0x89, 0xbc);
const BLUE: Color = Color::Rgb(0x81, 0x9c, 0xd6);
const MAGENTA: Color = Color::Rgb(0xa6, 0xc1, 0xe0);
const VIOLET: Color = Color::Rgb(0xb0, 0xa2, 0xe7);
