...
const BG: Color = Color::Rgb(0x27, 0x21, 0x2E);
const BG_ALT: Color = Color::Rgb(0x1B, 0x17, 0x20);
const FG: Color = Color::Rgb(0xFF, 0xFF, 0xFF);
const FG_ALT: Color = Color::Rgb(0xEE, 0xEE, 0xEE);
const BASE4: Color = Color::Rgb(0x96, 0x4C, 0x7B);
const RED: Color = Color::Rgb(0x96, 0x4C, 0x7B);
const ORANGE: Color = Color::Rgb(0xFF, 0xB8, 0x5B);
const YELLOW: Color = Color::Rgb(0xFF, 0xE2, 0x61);
const GREEN: Color = Color::Rgb(0x74, 0xDF, 0xC4);
const CYAN: Color = Color::Rgb(0xB4, 0xDC, 0xE7);
const BLUE: Color = Color::Rgb(0x40, 0xB4, 0xC4);
const MAGENTA: Color = Color::Rgb(0xEB, 0x64, 0xB9);
const VIOLET: Color = Color::Rgb(0xB3, 0x81, 0xC5);
