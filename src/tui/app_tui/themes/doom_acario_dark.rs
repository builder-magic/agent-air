...
const BG: Color = Color::Rgb(0x0D, 0x0E, 0x16);
const BG_ALT: Color = Color::Rgb(0x14, 0x15, 0x1E);
const FG: Color = Color::Rgb(0xBC, 0xBC, 0xBC);
const FG_ALT: Color = Color::Rgb(0x55, 0x55, 0x66);
const BASE4: Color = Color::Rgb(0x55, 0x55, 0x66);
const RED: Color = Color::Rgb(0xE6, 0x19, 0x38);
const ORANGE: Color = Color::Rgb(0xE6, 0x87, 0x2B);
const YELLOW: Color = Color::Rgb(0xE6, 0xE6, 0x2B);
const GREEN: Color = Color::Rgb(0x55, 0xE6, 0x55);
const CYAN: Color = Color::Rgb(0x55, 0xE6, 0xE6);
const BLUE: Color = Color::Rgb(0x55, 0x55, 0xE6);
const MAGENTA: Color = Color::Rgb(0xE6, 0x55, 0xE6);
const VIOLET: Color = Color::Rgb(0xAA, 0x55, 0xE6);
