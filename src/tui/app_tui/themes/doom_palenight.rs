...
// Color palette
const BG: Color = Color::Rgb(0x29, 0x2D, 0x3E);
const BG_ALT: Color = Color::Rgb(0x24, 0x28, 0x37);
const FG: Color = Color::Rgb(0xEE, 0xFF, 0xFF);
const FG_ALT: Color = Color::Rgb(0x67, 0x6E, 0x95);
const BASE4: Color = Color::Rgb(0x4E, 0x55, 0x79);
