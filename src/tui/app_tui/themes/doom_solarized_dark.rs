...
// Color palette
const BG: Color = Color::Rgb(0x00, 0x2b, 0x36);
const BG_ALT: Color = Color::Rgb(0x00, 0x21, 0x2B);
const FG: Color = Color::Rgb(0x83, 0x94, 0x96);
const FG_ALT: Color = Color::Rgb(0x65, 0x7b, 0x83);
const BASE4: Color = Color::Rgb(0x56, 0x69, 0x7A);
