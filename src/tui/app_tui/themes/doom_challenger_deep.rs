...
const BG: Color = Color::Rgb(0x1E, 0x1C, 0x31);
const BG_ALT: Color = Color::Rgb(0x12, 0x11, 0x1E);
const FG: Color = Color::Rgb(0xCB, 0xE3, 0xE7);
const FG_ALT: Color = Color::Rgb(0x56, 0x55, 0x75);
const BASE4: Color = Color::Rgb(0x56, 0x55, 0x75);
const RED: Color = Color::Rgb(0xFF, 0x80, 0x80);
const ORANGE: Color = Color::Rgb(0xFF, 0xB3, 0x78);
const YELLOW: Color = Color::Rgb(0xFF, 0xE9, 0xAA);
const GREEN: Color = Color::Rgb(0x95, 0xFF, 0xA4);
const CYAN: Color = Color::Rgb(0xAA, 0xFF, 0xE4);
const BLUE: Color = Color::Rgb(0x91, 0xDD, 0xFF);
const MAGENTA: Color = Color::Rgb(0xC9, 0x91, 0xE1);
const VIOLET: Color = Color::Rgb(0x90, 0x6C, 0xFF);
