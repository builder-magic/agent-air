...
// Color palette
const BG: Color = Color::Rgb(0x1D, 0x25, 0x2C);
const BG_ALT: Color = Color::Rgb(0x18, 0x1E, 0x24);
const FG: Color = Color::Rgb(0xA0, 0xB3, 0xC5);
const FG_ALT: Color = Color::Rgb(0x56, 0x69, 0x7A);
const BASE4: Color = Color::Rgb(0x38, 0x45, 0x51);
const RED: Color = Color::Rgb(0xD9, 0x54, 0x68);
const ORANGE: Color = Color::Rgb(0xD9, 0x8E, 0x48);
const YELLOW: Color = Color::Rgb(0xEB, 0xBF, 0x83);
const GREEN: Color = Color::Rgb(0x8B, 0xD4, 0x9C);
const CYAN: Color = Color::Rgb(0x70, 0xE1, 0xE8);
const BLUE: Color = Color::Rgb(0x5E, 0xC4, 0xFF);
const MAGENTA: Color = Color::Rgb(0xE2, 0x7E, 0x8D);
const VIOLET: Color = Color::Rgb(0xB6, 0x2D, 0x65);
