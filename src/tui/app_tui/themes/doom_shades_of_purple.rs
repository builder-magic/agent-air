...
const BG: Color = Color::Rgb(0x2D, 0x2B, 0x55);
const BG_ALT: Color = Color::Rgb(0x1E, 0x1C, 0x3F);
const FG: Color = Color::Rgb(0xFF, 0xFF, 0xFF);
const FG_ALT: Color = Color::Rgb(0xA5, 0x99, 0xE9);
const BASE4: Color = Color::Rgb(0x69, 0x62, 0x9E);
const RED: Color = Color::Rgb(0xEC, 0x30, 0x36);
const ORANGE: Color = Color::Rgb(0xF9, 0x93, 0x58);
const YELLOW: Color = Color::Rgb(0xFA, 0xD0, 0x00);
const GREEN: Color = Color::Rgb(0x3A, 0xD9, 0x00);
const CYAN: Color = Color::Rgb(0x80, 0xFF, 0xEA);
const BLUE: Color = Color::Rgb(0x69, 0x43, 0xFF);
const MAGENTA: Color = Color::Rgb(0xFF, 0x7A, 0xCB);
const VIOLET: Color = Color::Rgb(0xB3, 0x62, 0xFF);
