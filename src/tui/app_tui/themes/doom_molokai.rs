...
const BG: Color = Color::Rgb(0x1c, 0x1e, 0x1f);
const BG_ALT: Color = Color::Rgb(0x22, 0x23, 0x23);
const FG: Color = Color::Rgb(0xd6, 0xd6, 0xd4);
const FG_ALT: Color = Color::Rgb(0x55, 0x61, 0x72);
const BASE4: Color = Color::Rgb(0x55, 0x61, 0x72);
const RED: Color = Color::Rgb(0xe7, 0x4c, 0x3c);
const ORANGE: Color = Color::Rgb(0xfd, 0x97, 0x1f);
const YELLOW: Color = Color::Rgb(0xe2, 0xc7, 0x70);
const GREEN: Color = Color::Rgb(0xb6, 0xe6, 0x3e);
const CYAN: Color = Color::Rgb(0x66, 0xd9, 0xef);
const BLUE: Color = Color::Rgb(0x26, 0x8b, 0xd2);
const MAGENTA: Color = Color::Rgb(0xfb, 0x28, 0x74);
