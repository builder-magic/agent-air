...
// Color palette
const BG: Color = Color::Rgb(0x23, 0x25, 0x30);
const BG_ALT: Color = Color::Rgb(0x1c, 0x1e, 0x26);
const FG: Color = Color::Rgb(0xc7, 0xc9, 0xcb);
const FG_ALT: Color = Color::Rgb(0x6a, 0x6a, 0x6a);
const BASE4: Color = Color::Rgb(0x6a, 0x6a, 0x6a);
const RED: Color = Color::Rgb(0xe9, 0x56, 0x78);
const ORANGE: Color = Color::Rgb(0xf0, 0x93, 0x83);
const YELLOW: Color = Color::Rgb(0xfa, 0xb7, 0x95);
const GREEN: Color = Color::Rgb(0x09, 0xf7, 0xa0);
const CYAN: Color = Color::Rgb(0x59, 0xe3, 0xe3);
const BLUE: Color = Color::Rgb(0x21, 0xbf, 0xc2);
const MAGENTA: Color = Color::Rgb(0xb8, 0x77, 0xdb);
const VIOLET: Color = Color::Rgb(0xb8, 0x77, 0xdb);
